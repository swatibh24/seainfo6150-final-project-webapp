    ...
    return(
      <div className={styles.recipeContainer}>
        ...
        <p className={styles.box}>
          <Link className={styles.catBackLink} to={props.recipe.categoryURL}> &lt; Back to {props.recipe.categoryName} Page</Link>
          <Link className={styles.recipeBackLink} to="/recipes">Back to All Recipes Page &gt;</Link>
        </p>
        <img className={styles.recipeImg} src={props.recipe.imageURL} alt={props.recipe.name} />
